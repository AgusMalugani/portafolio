...
function Sidebar() {
  ...
  if (isMobile) {
    // Navbar para versión móvil
    return (
      <nav className="top-0 left-0 w-full bg-sky-700 shadow-md z-50 flex justify-between items-center px-4 py-3">
    <h1 className="font-bold text-xl">Agustin Malugani</h1>
  ...
  return (
    <aside className={`fixed top-0 left-0 h-full w-96 shadow-md flex flex-col justify-between py-10 px-4 transition-transform md:translate-x-0`}>
      <div>
        {/* Imagen de perfil */}
